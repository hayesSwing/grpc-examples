...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.xiangzi.service.api.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.xiangzi.service.HelloServiceApi.LookupRequest,
      com.xiangzi.service.HelloServiceApi.Coordinate> getLookupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Lookup",
      requestType = com.xiangzi.service.HelloServiceApi.LookupRequest.class,
      responseType = com.xiangzi.service.HelloServiceApi.Coordinate.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.xiangzi.service.HelloServiceApi.LookupRequest,
      com.xiangzi.service.HelloServiceApi.Coordinate> getLookupMethod() {
    io.grpc.MethodDescriptor<com.xiangzi.service.HelloServiceApi.LookupRequest, com.xiangzi.service.HelloServiceApi.Coordinate> getLookupMethod;
    if ((getLookupMethod = HelloServiceGrpc.getLookupMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getLookupMethod = HelloServiceGrpc.getLookupMethod) == null) {
          HelloServiceGrpc.getLookupMethod = getLookupMethod =
              io.grpc.MethodDescriptor.<com.xiangzi.service.HelloServiceApi.LookupRequest, com.xiangzi.service.HelloServiceApi.Coordinate>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Lookup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xiangzi.service.HelloServiceApi.LookupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xiangzi.service.HelloServiceApi.Coordinate.getDefaultInstance()))
              .setSchemaDescriptor(new HelloServiceMethodDescriptorSupplier("Lookup"))
              .build();
        }
      }
    }
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void lookup(com.xiangzi.service.HelloServiceApi.LookupRequest request,
        io.grpc.stub.StreamObserver<com.xiangzi.service.HelloServiceApi.Coordinate> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.xiangzi.service.HelloServiceApi.LookupRequest,
                com.xiangzi.service.HelloServiceApi.Coordinate>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.xiangzi.service.HelloServiceApi.Coordinate lookup(com.xiangzi.service.HelloServiceApi.LookupRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.xiangzi.service.HelloServiceApi.Coordinate> lookup(
        com.xiangzi.service.HelloServiceApi.LookupRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOOKUP:
          serviceImpl.lookup((com.xiangzi.service.HelloServiceApi.LookupRequest) request,
              (io.grpc.stub.StreamObserver<com.xiangzi.service.HelloServiceApi.Coordinate>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.xiangzi.service.HelloServiceApi.getDescriptor();
    }
